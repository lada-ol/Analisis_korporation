...
### 4.4.1. Демографическое равенство
| Признак | p-value | Cramér's V | Вывод |
|---------|---------|------------|-------|
| Отрасль | 0.1199 | 0.5024 | Статистически значимых различий нет |
| Размер | 0.1375 | 0.3714 | Статистически значимых различий нет |
| Регион | 0.2552 | 0.3185 | Статистически значимых различий нет |

### 4.4.2. Равенство возможностей
...
### 4.4.3. Предсказательное равенство
...
**Вывод по этическому аудиту:** Алгоритм не создаёт систематических необоснованных смещений по проверенным признакам.

## 4.5. Оценка рисков

### 4.5.1. Сценарный анализ
...
## 5.2. Рекомендации по риск-менеджменту

- При планировании бюджета использовать пессимистический сценарий (0.00 млн руб.)
- Проводить регулярный этический мониторинг (ежеквартально)
- Пересматривать порог отбора при изменении рыночных условий
